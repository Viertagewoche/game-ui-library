            ...
            <div className="sticky top-24">
              ...
              {elementGroups.map(({ name, items }) => (
                <div key={name} className="mb-4">
                  <p className="text-[10px] uppercase tracking-widest text-muted-foreground/60 mb-2">{name}</p>
                  {items.map((el) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="text-xs text-muted-foreground/60 tabular-nums">{el.count}</span>
                      </button>
                    )
                  })}
                </div>
